...
//			'comment' => remove_emoji($_POST['comment']), 
			'comment' => wp_kses(wp_unslash($_POST['comment']), 'default'), 
			'rating'  => (int)$_POST['rating'],
//			'doc'     => $_POST['doc'],
			'doc'     => wp_kses(wp_unslash($_POST['doc']), 'default'), 
			'status'     => 'new'
		), array('%d', '%d', '%s', '%d', '%s', '%s'));
		if( $result == false){
...
<?php get_header('old'); ?>
	<div class="cover-container container">
		<main class="text-center">
			<p class="lead">В Беларуси есть немало организаций, которые готовы помогать призывникам. Некоторые делают это платно, а некоторые бесплатно, но все пишут у себя на сайте, что они лучшие и обращаться надо именно к ним. Так ли это на самом деле? Мы сделали независимую площадку, где каждый может оставить реальный отзыв и свою историю обращений в эти организации!</p>
