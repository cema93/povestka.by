...
<head>
	...
	<link rel="preload" as="font" type="font/woff2" crossorigin href="https://povestka.by/wp-content/themes/stable/fonts/fontawesome-webfont.woff2?v=4.7.0"/>
	<link rel="stylesheet" href="https://povestka.by/wp-content/themes/stable/css/main.css">
	<?php wp_head(); ?>
...
<div class="main-content-wraper">
	<header>
		...
		<div class="container">
			<?php
				global $site_error;
				if ( $site_error->get_error_code() ) {
					foreach( $site_error->get_error_messages() as $error ){
