					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<?php if(display_ad() AND wp_is_mobile()) { ?>
								...
								<div id="yandex_rtb_R-A-270077-10-<?php echo $i; ?>"></div>
									...
									(function(w, d, n, s, t) {
										...
										w[n].push(function() {
											Ya.Context.AdvManager.render({
												...
												renderTo: "yandex_rtb_R-A-270077-10-<?php echo $i; ?>",
							...
							<?php if(display_ad() AND !wp_is_mobile()) { ?>
								...
								<div id="yandex_rtb_R-A-270077-2-<?php echo $i; ?>"></div>
								<script type="text/javascript">
									(function(w, d, n, s, t) {
										w[n] = w[n] || [];
										w[n].push(function() {
											Ya.Context.AdvManager.render({
												...
												renderTo: "yandex_rtb_R-A-270077-2-<?php echo $i; ?>",
												pageNumber: <?php echo $i; ?>,
												async: true
											});
										});
