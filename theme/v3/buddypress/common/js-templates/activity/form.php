...
<script type="text/html" id="tmpl-activity-post-form-feedback">
	<span class="bp-icon" aria-hidden="true"><i class="fa fa-exclamation-circle" aria-hidden="true"></i></span><p>{{{data.message}}}</p>
</script>
...
<script type="text/html" id="tmpl-activity-target-item">
	...
	<# if ( data.selected ) { #>
		<button type="button" class="bp-remove-item fa fa-times" data-item_id="{{data.id}}">
		<button type="button" class="bp-remove-item fa fa-times" data-item_id="{{data.id}}">
