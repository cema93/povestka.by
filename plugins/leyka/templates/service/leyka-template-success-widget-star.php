            ...
            <div id="leyka-pf-" class="leyka-pf leyka-pf-star">
                ...
                <div class="leyka-pf__final-screen">
                    ...
                    <div class="leyka-screen-form leyka-screen-thankyou <?php echo $template_id === 'need-help' ? 'leyka-need-help-thankyou' : '';?>">
                        ...
                        <p>Огромное спасибо Вам за помощь. Благодарим за Ваши усилия, поддержку и потраченное время. Желаем Вам никогда не испытывать жизненных трудностей, получать от жизни все блага и радоваться каждому дню!<br><br> Искренне благодарим вас,<br> Команда Центра прав призывника.</p>
