					...
					<div class="leyka-account-form">
						...
						<form class="leyka-screen-form">
							...
							<div class="list subscribed-campaigns-list">
                                ...
                                <?php } else {?>
                                <div class="donations-history-empty">Чтобы включить ежемесячные пожертвования <a href="https://povestka.by/news/nash-sajt-rabotaet-blagodarya-vashej-podderzhke/#leyka-pf-24406-star-form">перейдите по ссылке</a> и выберете сумму.</div>
                                <?php }?>
							</div>
							...
							<div class="list leyka-star-history">
                                ...
                                <?php } else {?>
                                    <div class="donations-history-empty">
                                       Чтобы сделать пожертвование <a href="https://povestka.by/news/nash-sajt-rabotaet-blagodarya-vashej-podderzhke/#leyka-pf-24406-star-form">перейдите по ссылке</a>
                                    </div>
                                <?php }
