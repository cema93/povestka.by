...
@section('content')
		...
		<form class="form" name="createCampaign" action="create" enctype="multipart/form-data" method="post">
      ...
      <div class="form__info row">
			...
			<div class="form__desc">
				<div class="desc-of-campaign">
					...
					<textarea class="desc-of-campaign__input" name="description" id="descriptionOfCampaign" cols="30" rows="10">{{ old('description') }}</textarea>
				</div>
