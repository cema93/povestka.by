...
@section('content')
      ...
      <div class="form__desc">
        <div class="desc-of-campaign">
          ...
          <textarea class="desc-of-campaign__input" name="description" id="descriptionOfCampaign" cols="30" rows="10">{{ $description }}</textarea>
        </div>
        <div class="add-picture">
          ...
          <div class="selected-picture"><img id="image" src="{{ 'images/'.$photo }}"></div>
        </div>
      </div>
